...
# Aufruf:   docker buildx bake [noble|azul]
...
target "noble" {
  tags = ["docker.io/juergenzimmermann/kunde:2025.10.3-eclipse-noble"]
  #dockerfile = "Dockerfile"
  # context = "."
}

target "azul" {
  tags = ["docker.io/juergenzimmermann/kunde:2025.10.3-azul"]
