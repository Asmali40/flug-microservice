...
# Aufruf:   .\port-forward.ps1 [flug|pgadmin|fakesmtp]
...
switch ($service) {
    'flug' { $port=8443 }
    'pgadmin' { $port='8888:80' }
    'fakesmtp' { $port='8026:8080' }
    default { throw "Usage: $MyInvocation.MyCommand [flug|pgadmin|fakesmtp]" }
}
