...
.Use Cases für den Microservice "flug"
...
."FlugController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,FlugController,svg]
----
include::./FlugController.plantuml[]
----
...
.Die Service-Klasse "FlugService" für die Geschäftslogik
[plantuml,FlugService,svg]
----
include::./FlugService.plantuml[]
----
